...
def render_graph_DefaultRenderGraph():
    ...
    loadRenderPassLibrary('RadianceRebuilder2.dll')
    ...
    g.addEdge('VBufferRT.vbuffer', 'RadianceRebuilder2.vbuffer')
    g.addEdge('RadianceRebuilder2.color', 'ToneMapper.src')
